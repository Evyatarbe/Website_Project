        ...
        <div>
            ...
            <div style={styles.pageContainer}>
                ...
                <div style={styles.photo}>
                    <img src={require("./logos/black.jpeg")} width={500} height={500} />
                </div>

                <div style={styles.column}>
                    <p style={styles.graph}>
                        * For this anime imdb page <Link onClick={() => window.open('https://www.imdb.com/title/tt7441658/', '_blank')} style={styles.pointer} >Click here</Link>.
                    </p>
                </div>

                <div style={styles.column}>
                    <p style={styles.graph}>
                        * To watch this anime online <Link onClick={() => window.open('https://anihdplay.com/videos/black-clover-tv-episode-1', '_blank')} style={styles.pointer} >Click here</Link>.
                    </p>
                </div>

                <div style={styles.column}>
                    <p style={styles.graph}>
                        * For this anime fandom page <Link onClick={() => window.open('https://blackclover.fandom.com/wiki/Black_Clover_Wiki', '_blank')} style={styles.pointer} >Click here</Link>.
                    </p>
                </div>
