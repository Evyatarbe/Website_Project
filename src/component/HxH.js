        ...
        <div>
            ...
            <div style={styles.pageContainer}>
                ...
                <div style={styles.photo}>
                    <img src={require("./logos/hxh.jpeg")} width={500} height={500} />
                </div>

                <div style={styles.column}>
                    <p style={styles.graph}>
                        * For this anime imdb page <Link onClick={() => window.open('https://www.imdb.com/title/tt2098220/', '_blank')} style={styles.pointer} >Click here</Link>.
                    </p>
                </div>

                <div style={styles.column}>
                    <p style={styles.graph}>
                        * To watch this anime online <Link onClick={() => window.open('https://anihdplay.com/videos/hunter-x-hunter-2011-episode-1', '_blank')} style={styles.pointer} >Click here</Link>.
                    </p>
                </div>

                <div style={styles.column}>
                    <p style={styles.graph}>
                        * For this anime fandom page <Link onClick={() => window.open('https://hunterxhunter.fandom.com/wiki/Hunterpedia', '_blank')} style={styles.pointer} >Click here</Link>.
                    </p>
                </div>
